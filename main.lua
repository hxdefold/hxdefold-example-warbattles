...
_hx_exports["warbattles"] = _hx_exports["warbattles"] or _hx_e()
local Array = _hx_e()
local Math = _hx_e()
local String = _hx_e()
local Std = _hx_e()
...
_hx_exports["warbattles"]["Player"] = __warbattles_Player
...
__warbattles_Player.prototype.update = function(self,_self,dt) 
  ...
  if (_self.firing) then 
    local angle = _G.math.atan2(_self.dir.y, _self.dir.x);
    local rot = _G.vmath.quat_rotation_z(angle);
    local props = ({});
    props.dir = _self.dir;
...
_hx_exports["warbattles"]["Rocket"] = __warbattles_Rocket
...
__warbattles_Rocket.prototype.on_message = function(self,_self,message_id,message,sender) 
  ...
  if (message_id1) == __defold_SpriteMessages.animation_done then 
    _G.go.delete();
  elseif (message_id1) == __defold_PhysicsMessages.collision_response then 
    self:explode(_self);
...
_hx_exports["warbattles"]["Ui"] = __warbattles_Ui
...
__warbattles_Ui.prototype.on_message = function(self,_self,message_id,message,sender) 
  if (message_id == __warbattles_Ui.add_score) then 
    local self1 = _self;
    self1.score = self1.score + message.score;
    local scorenode = _G.gui.get_node("score");
    _G.gui.set_text(scorenode, Std.string("SCORE: ") .. Std.string(_self.score));
  end;
end
...
local _hx_static_init = function()
  __defold_GoMessages.acquire_input_focus = (function() 
    local _hx_1
  ...
  __defold_GoMessages.release_input_focus = (function() 
    local _hx_2
  ...
  __defold_PhysicsMessages.collision_response = (function() 
    local _hx_3
  ...
  __defold_SpriteMessages.animation_done = (function() 
    local _hx_4
  ...
  __defold_SpriteMessages.play_animation = (function() 
    local _hx_5
  ...
  __warbattles_Ui.add_score = (function() 
    local _hx_6
    
    local this1 = _G.hash("add_score");
